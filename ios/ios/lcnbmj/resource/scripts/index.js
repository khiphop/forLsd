        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    _a.label = 7;
                case 7: return [2 /*return*/, isDccOk];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, updateDcc(cache, urlpath)];
                case 2:
                    isDccOk = _a.sent();
                    if (!isDccOk) {
...
//window.loadGameUrl = "https://pmini.fhabc.com/app/he_cheng_app_test/index.html" //外测
window.loadGameUrl = "https://pmini.fhabc.com/app/he_cheng_app/index.html" //正式
//window.loadGameUrl = "http://bjtest.bianjiwangluo.cn/minires/he_cheng_app/index.html" //内测


loadUrl(conch.presetUrl || window.loadGameUrl);
